...
public class AbstractResourceBuilder implements XResourceBuilder {
    ...
    private AbstractResource module;
    ...
    @Override
    public XResourceBuilder createResource(String name, Version version) {
        return this;
    }
    ...
    @Override
    public XResourceBuilder addBundleClassPath(String... paths) {
        assertModuleCreated();
    ...
    @Override
    public XResourceBuilder addModuleActivator(String moduleActivator) {
        assertModuleCreated();
