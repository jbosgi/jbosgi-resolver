...
public class AbstractIdentityRequirement extends AbstractRequirement implements XIdentityRequirement {
    ...
    protected AbstractIdentityRequirement(Resource resource, Map<String, Object> attributes, Map<String, String> directives) {
        super(resource, WIRING_BUNDLE_NAMESPACE, attributes, directives);
        this.symbolicName = (String) getAttribute(WIRING_BUNDLE_NAMESPACE);
        if (symbolicName == null)
            throw new IllegalArgumentException("Null symbolicName");
        Object versionatt = attributes.get(BUNDLE_VERSION_ATTRIBUTE);
