...
// TODO: RFC-112 - We need a constant here.
    ...
    **/
    public void prepare(FelixEnvironment env) throws ResolutionException
    {
            ...
            hostEntry : hostFragments.entrySet())
        {
            ...
            HostResource wrappedHost =
                new HostResource(env, hostCap.getResource(), selectedFragments);
     ...
     * @throws ResolutionException if removing the module caused the resolve to fail.
    **/
    private void removeRevision(Resource revision, ResolutionException ex) throws ResolutionException
    {
    ...
    **/
    public Candidates copy()
    {
        ...
        return new Candidates(m_logger,
    ...
    public void dump(FelixEnvironment env)
    {
        ...
        m_logger.log(Logger.LOG_TRACE, "=== BEGIN CANDIDATE MAP ===");
        for (Resource res : resources)
        {
            m_logger.log(Logger.LOG_TRACE, "  " + res
        ...
        m_logger.log(Logger.LOG_TRACE, "=== END CANDIDATE MAP ===");
    }
}